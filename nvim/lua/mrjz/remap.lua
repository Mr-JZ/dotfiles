...
-- change the possition of the marked text
...
-- This is going to get me cancelled TODO change because it can be better implemented
...
vim.keymap.set("n", "<leader>vpp", "<cmd>e ~/.config/nvim/lua/mrjz/packer.lua<CR>");
